...
const elements = {
  ...
  brandLogoImg: byId<HTMLImageElement>("brand-logo-img"),
  brandLogoFallback: byId("brand-logo-fallback"),
...
async function bootstrap(): Promise<void> {
  ...
  if (data.brand.logoPath) {
    elements.brandLogoImg.src = data.brand.logoPath;
    elements.brandLogoImg.hidden = false;
    elements.brandLogoFallback.hidden = true;
    elements.brandLogoImg.onerror = () => {
      elements.brandLogoImg.hidden = true;
      elements.brandLogoFallback.hidden = false;
    };
  }
