...
- **Versioning Standard:** Strict Semantic Versioning MAJOR.MINOR.PATCH with an optional prerelease label. Build/package and UI surfaces use `1.0.1-beta`. Do not use floating tags like `latest` in release targets.
