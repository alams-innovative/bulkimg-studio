...
const updateReleases = [
  { version: "1.0.9", tag: "v1.0.9", channel: "stable", publishedAt: "2026-08-09T00:00:00.000Z", releaseNotesUrl: "https://github.com/alams-innovative/bulkimg-studio/releases/tag/v1.0.9", minimumSupportedVersion: "1.0.0", architectures: ["x64"], schemaVersion: 7, available: true, unavailableReason: null, isCurrent: false },
...
const updateState = (state: HarnessState) => ({
  configured: true, currentVersion: "1.0.9", channel: state.updateChannel, lastCheckedAt: new Date().toISOString(), lastError: null,
  activity: state.downloadedUpdateVersion ? "ready" as const : "idle" as const, progress: null,
  available: updateReleases.find((release) => release.version === "1.0.9") ?? null,
